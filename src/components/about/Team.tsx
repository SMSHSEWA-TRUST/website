...
const defaultTeamMembers = [
    { name: "Abhinavan Subramanian", role: "Position Holding", image: teamImage },
    { name: "Abhinavan Subramanian", role: "Position Holding", image: teamImage },
    { name: "Abhinavan Subramanian", role: "Position Holding", image: teamImage },
    { name: "Abhinavan Subramanian", role: "Position Holding", image: teamImage },
    { name: "Abhinavan Subramanian", role: "Position Holding", image: teamImage },
                    ...
                    <div className="relative bg-white w-full mx-4 rounded-lg shadow-2xl max-w-[400px] sm:max-w-[640px] lg:max-w-[1134px] max-h-[90vh] overflow-auto">
                        ...
                        <div className="flex flex-col-reverse lg:flex-row min-h-0 lg:min-h-[500px] h-full">
                            ...
                            <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-8 bg-white flex flex-col overflow-auto">
                                ...
                                {/* Description */}
                                <p className="text-gray-700 textDescription leading-relaxed mb-6 lg:mb-8">
                                ...
                                <div className="flex gap-3">
                                    {/* Facebook */}
                                    <div className="w-10 h-10 rounded-full border-2 flex items-center justify-center hover:bg-red-50 cursor-pointer transition-colors duration-200" style={{ borderColor: '#AD2F16', color: '#AD2F16' }}>
                                    ...
                                    {/* Instagram */}
                                    <div className="w-10 h-10 rounded-full border-2 flex items-center justify-center hover:bg-red-50 cursor-pointer transition-colors duration-200" style={{ borderColor: '#AD2F16', color: '#AD2F16' }}>
                                        {/* Proper Instagram icon: rounded square, inner camera circle, and small flash/dot */}
