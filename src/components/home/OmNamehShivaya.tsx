        ...
        <>
            <section className="relative w-full  overflow-hidden">
                ...
                <div className="flex flex-col lg:hidden items-center gap-4 relative mb-2">
                    ...
                    <div className="w-full -mt-20 z-20 mx-auto">
                        <div className={`relative transform transition-all duration-300 ${isPlaying ? 'scale-105 shadow-2xl' : 'shadow-xl'} rounded overflow-hidden`}>
                            {multipurposeItem && (
                                <div className="relative group cursor-pointer" onClick={handleVideoClick}>
                                    <video
                                        ref={videoRef}
                                        className={`w-full h-[280px] object-cover transition-opacity duration-300 ${isPlaying ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
                                        muted={isMuted}
                                        loop
                                        playsInline
                                    >
                                    ...
                                    {!isPlaying && (
                                        <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/30 transition-all">
                                            <div className="relative flex items-center justify-center">
                                                <div
                                                    className="absolute w-16 h-16 bg-white rounded-full opacity-75 animate-ping"
                                                    style={{ animationDuration: '4s' }}
                                                ></div>
                                                <div className="relative w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-500">
                                    ...
                                    >
                                        {isMuted ? (
                                            ...
                                            <svg className="w-5 h-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z" />
                                            </svg>
                                        )}
                                    </button>
                                </div>
                    ...
                    <div className="w-full h-50 flex-shrink-0 -mt-20">
                        <div className="group relative h-[300px] overflow-hidden rounded-lg shadow-xl">
                            <img
                                src={templeImage2}
                                alt="Temple View 2"
